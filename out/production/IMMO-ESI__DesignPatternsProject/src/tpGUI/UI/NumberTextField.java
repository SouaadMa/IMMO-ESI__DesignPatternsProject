...
import java.math.BigDecimal; import java.text.NumberFormat; import java.text.ParseException; 
...
public class NumberTextField extends TextField {
    ...
    public NumberTextField() {       this(BigDecimal.ZERO);     } 
    ...
    private void initHandlers() { 
    	...
    	setOnAction(new EventHandler<ActionEvent>() { 
            ...
            @Override             
            public void handle(ActionEvent arg0) {                 parseAndFormatInput();             }         
            }); 
        ...
        focusedProperty().addListener(new ChangeListener<Boolean>() { 
            ...
            public void changed(ObservableValue<? extends Boolean> observable, Boolean oldValue, Boolean newValue) {                 
            	if (!newValue.booleanValue()) {                     parseAndFormatInput();                 }             }         
            }); 
