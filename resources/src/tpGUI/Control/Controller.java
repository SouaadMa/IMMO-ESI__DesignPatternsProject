...
public class Controller {
    ...
    protected static PrincipalWindow fenetreprincipale;
        ...
        if(!accueil) {
            ...
            if(agence.getBiens().isEmpty()) MainPage.CustomErreur("La liste des biens est vide !");
                ...
                while(it.hasNext())
                {
                    ...
                    InfoBiens stage = new InfoBiens(b, view, this.vbox);
                ...
                if (event.getSource() == superficie) {
                    ...
                    if (event.getSource() == proprietaire) {
                        ...
                        if (event.getSource() == prix) {
                            ...
                            try {
                                URL url2 = new File("resources/img/prix.jpg").toURI().toURL();
    ...
    public void quitterClicked() throws Exception {
        ...
        out = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream(new File("resources/Sauvegarde.txt"))));
