...
public class Controller {
    ...
    protected static Scene view;
    protected static boolean accueil = false;
    protected static boolean archive = false;
    protected static boolean valider = false;
    protected static boolean admin=false;
    protected static boolean bool = false;
    protected static String tab[] = {"Adresse", "Wilaya souhaitee", "Superficie", "Coordonnees d'un proprietaire", "Prix", "Type de transaction", "Date", "Le type du bien", "Nombre maximal des pieces"};
    ...
    int i = 0;
    protected static Set<Biens> ensembleBiens;
    ...
    protected static boolean firstConnexion=true;
  ...
  @FXML
  protected ComboBox<String> cb = new ComboBox<String>();
  ...
  @FXML
  protected HBox bigHbox;
  
  



    public void setInfo(Set<Biens> ensembleBien, Agence agenc) {

        ensembleBiens = ensembleBien;
        agence = agenc;
    ...
    public void accueilClicked() {
        ...
        if(!accueil) {
        	...
        	bigHbox.getChildren().addAll(buttonsVbox, sp, connexionButton);
        	
        	vbox.getChildren().clear();

            
            if(agence.getBiens().isEmpty()) MainPage.CustomErreur("La liste des biens est vide !");
			else {
    ...
    public void rechercher(ActionEvent event) {
        ...
        if (event.getSource() == adresse) {
            ...
            i = 1;
            try {
            	 URL url2 = new File("adresseImage.jpg").toURI().toURL();
            ...
            if (event.getSource() == wilaya) {
                ...
                try {
               	 URL url2 = new File("wilaya.jpg").toURI().toURL();
               ...
               image.setImage( new Image(url2.toString() ) );
                ...
                if (event.getSource() == superficie) {
                    ...
                    try {
                      	 URL url2 = new File("superficie.jpg").toURI().toURL();
                    ...
                    if (event.getSource() == proprietaire) {
                        ...
                        try {
                          	 URL url2 = new File("proprietaire.jpg").toURI().toURL();
                        ...
                        if (event.getSource() == prix) {
                            ...
                            try {
                              	 URL url2 = new File("prix.jpg").toURI().toURL();
                            ...
                            if (event.getSource() == date) {
                                i = 7;
                                try {
                                  	 URL url2 = new File("date.jpg").toURI().toURL();
                                ...
                                if (event.getSource() == typeTrans) {
                                    ...
                                    try {
                                      	 URL url2 = new File("typetrans.jpg").toURI().toURL();
                                    ...
                                    if (event.getSource() == typeBien) {
                                        ...
                                        try {
                                         	 URL url2 = new File("typeBien.jpg").toURI().toURL();
                                        ...
                                        i = 9;
                                        try {
                                          	 URL url2 = new File("nbPieces.jpg").toURI().toURL();
        ...
        item1.setOnAction(new RechercherController(this, i, ensembleBiens, agence));
        item2.setOnAction(new RechercherController(this, i, ensembleBiens, agence));
        item3.setOnAction(new RechercherController(this, i, ensembleBiens, agence));
        buttonRechercher.setOnAction(new RechercherController(this, i, ensembleBiens, agence));
    }
    ...
    public void ajouterUnCritere() {
        ...
        image.setLayoutY(1);
        try {
       	 URL url2 = new File("aa.jpg").toURI().toURL();
    ...
    public void ajouterClicked() {
        ...
        AjoutBien stage = new AjoutBien(agence, view, vbox);
        ...
        while(it.hasNext()) {
            ...
            modif.setOnAction(new EventHandler<ActionEvent>(){
                ...
                public void handle(ActionEvent actionEvent) {
                    ...
                    vbox.getChildren().clear();
                    ModifBien stage = new ModifBien(vbox, agence, modif.getId(), vbox);
                    accueil=false;
            ...
            archiv.setOnAction(new EventHandler<ActionEvent>(){
        ...
        if(!archive) {
            ...
            while(it.hasNext())
            {
               ...
               InfoBiens stage = new InfoBiens(b, view, vbox);
                ...
                desarchiv.setOnAction(new EventHandler<ActionEvent>(){
                ...
                ((HBox)stage.getResultHbox()).getChildren().add(buttons);
    ...
    public void validerClicked() {
        ...
        if(!valider) {
            ...
            if(agence.getBiensAValider().isEmpty()) MainPage.CustomErreur("La liste des biens à valider est vide !");
			else {
    ...
    public void propClicked() {
        ...
        while(it.hasNext()) {
            ...
            affichebiens.setOnAction(new EventHandler<ActionEvent>(){
    ...
    public void connexionClicked() {
        ...
        if (admin)
        {
          ...
          fenetre.show();
            ...
            ConnexionAdmins fenetre = new ConnexionAdmins(this,agence);
            fenetre.show();
        ...
        while(it.hasNext()) {
            ...
            envoi.setOnAction(new EventHandler<ActionEvent>(){
                ...
                public void handle(ActionEvent actionEvent) {
                    ...
                    EnvoiMessage stage = new EnvoiMessage(agence.getBien(Integer.parseInt(envoi.getId())), view);
        ...
        while (it.hasNext()) {
            ...
            envoi.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    ...
                    AfficheMessages stage = new AfficheMessages(agence.getBien(Integer.parseInt(envoi.getId())), view);
    ...
    public void quitterClicked() throws Exception {
        ...
        out = new ObjectOutputStream(new BufferedOutputStream(new FileOutputStream(new File("Sauvegarde.txt"))));
    ...
    public static void setAgence(Agence agence) {
       tpGUI.Control.Controller.agence = agence;
    }

    public static void setView(Scene view) {
        tpGUI.Control.Controller.view = view;
    }
