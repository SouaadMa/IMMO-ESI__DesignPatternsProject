...
public class Agence implements Serializable
{
	...
	protected String[] criteres={ "adresse","wilaya souhaitee","superficie" , " coordonnees d'un proprietaire","prix" ,"type de transaction"  ,"date", "le type du bien" , "nombre maximal des pi�ces" };
	...
	public void consulterProp()
	{
		for(int i=0; i<nbProprietaires; i++) {
			System.out.println("Propri�taire "+i+" ");
		...
		while(Coherence==false)  {
			try {
				...
				switch(m) {
					...
					case 5: System.out.print("Saisissez <true> si le prix est n�gociable <false> sinon  :");
						neg = sc.nextBoolean(); m=6;
					case 6:	System.out.println("Saisissez le nom du propri�taire.");
						nom = sc.next();
					...
					case 9: if(type==1) {/*Maison*/
						switch (n) {
							...
							case 6:
								...
								System.out.println("Votre Maison a �t� cr�� avec succ�s.");
						}
					}
					else {
						if(type==2) { /*Appartement*/
							switch(n) {
								...
								case 4:
									...
									System.out.println("Votre appartement a �t� cr�� avec succ�s. ");
							}
						}
						else { /*NonHabitable*/
							switch(n) {
								case 0:
									...
									st = sc.next(); n=1;
								case 1:
									System.out.print("Nb Fa�ades : ");
									nb2 = sc.nextInt(); n=2;
								case 2:
									bien = new NonHabitable(adr, wi, sup, p, pr, neg, tr, des, f.format(date), "", st, nb2);
									System.out.println("Votre terrain a �t� cr�� avec succ�s. ");
							}
						}
					}
						/**E**/
				...
				System.out.println("Vous avez entr� un mauvais choix.");
			}
			...
			{
				System.out.println("Votre entr�e a g�n�r� un probl�me.");
			}
		}
		//inserBien(bien);
		return bien;
	...
	public void valideBien(Biens b) {
    	/*Suppression de la liste des biens � valider*/
